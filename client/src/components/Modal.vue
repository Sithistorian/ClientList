...
<h1 v-if="showEditModal"><button>Delete</button><button>Cancel</button><button>Save Client</button></h1>
<h1 v-if="showNewClientModal"><button>Cancel</button><button>Add Client</button></h1>
</template>
